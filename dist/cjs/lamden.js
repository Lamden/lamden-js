...
var bip32 = require('ed25519-hd-key');
...
var bip32__default = /*#__PURE__*/_interopDefaultLegacy(bip32);
...
var validators = /*@__PURE__*/getDefaultExportFromCjs(dist.exports);
 ...
 */
var CryptoJS$8 = CryptoJS$8 || (function (Math, undefined$1) {
    /**
     * CryptoJS namespace.
     */
    var C = {};
...
core.CryptoJS = CryptoJS$8;

var CryptoJS$7 = core.CryptoJS;
 ...
 */
CryptoJS$4.lib.Cipher || (function (undefined$1) {
    // Shortcuts
    var C = CryptoJS$4;
    var C_lib = C.lib;
    var Base = C_lib.Base;
...
var JsonFormatter$2 = {
	stringify: function (cipherParams) {
		...
		var jsonObj = {
			ct: cipherParams.ciphertext.toString(CryptoJS$2.enc.Base64)
		};
	...
	parse: function (jsonStr) {
		...
		var cipherParams = CryptoJS$2.lib.CipherParams.create({
			ciphertext: CryptoJS$2.enc.Base64.parse(jsonObj.ct)
		});
		
		// optionally extract iv and salt
		if (jsonObj.iv) {
			cipherParams.iv = CryptoJS$2.enc.Hex.parse(jsonObj.iv);
		}
            
		if (jsonObj.s) {
			cipherParams.salt = CryptoJS$2.enc.Hex.parse(jsonObj.s);
		}
...
jsonformatter.JsonFormatter = JsonFormatter$2;
...
var JsonFormatter$1 = jsonformatter.JsonFormatter;

cryptojs.CryptoJS = CryptoJS$1;
...
function decryptObject(password, objString) {
  assertTypes$1.isStringWithValue(password);
  assertTypes$1.isStringWithValue(objString);
...
function decryptStrHash(password, encryptedString) {
  assertTypes$1.isStringWithValue(password);
  assertTypes$1.isStringWithValue(encryptedString);
